...
305 C=C(B AND 16):FOR I=13716 TO 13720:POKE I,C:NEXT:REM SHIFT
306 C=C(B AND 32):FOR I=13796 TO 13798:POKE I,C:NEXT:REM CTL
307 C=C(B AND 64):FOR I=13634 TO 13636:POKE I,C:NEXT:REM ALT
308 C=C(B AND 128):FOR I=13476 TO 13478:POKE I,C:NEXT:REM GUI
310 B=255-IN(-16385)
...
317 C=C(B AND 64):FOR I=13638 TO 13841:POKE I,C:NEXT:REM Menu
