...
600 GOSUB _nloutput:ARGS LIST$(NEXT):SCREEN 2
601 CLS:FOR C=0 TO 24:POKE SCREEN C*40,STRING$(40,C+30):NEXT
602 SCREEN 3:GOSUB _output:ARGS LIST$(NEXT):SCREEN 2
603 SAVE SCREEN "work/save40.txt",ASC
604 SCREEN 3:GOSUB _output:ARGS LIST$(NEXT)
605 LOAD "work/save40.txt",*S$,ASC

610 GOSUB _assert:ARGS "VAL(S$(0))=25"
612 FOR I=1 TO 2
613 GOSUB _assert:ARGS "S$(%%)=STRING$(40)" % (I)
614 NEXT
616 FOR I=3 TO 25
617 GOSUB _assert:ARGS "S$(%%)=STRING$(40,%%)" % (I,I+29)
618 NEXT

620 GOSUB _nloutput:ARGS LIST$(NEXT):SWAP SCREEN
621 CLS:FOR C=0 TO 24:POKE SCREEN C*80,STRING$(80,C+30):NEXT
622 SWAP SCREEN:GOSUB _output:ARGS LIST$(NEXT):SWAP SCREEN
623 SAVE SCREEN "work/save80.txt",ASC
624 SWAP SCREEN:GOSUB _output:ARGS LIST$(NEXT)
625 LOAD "work/save80.txt",*S$,ASC

630 GOSUB _assert:ARGS "VAL(S$(0))=25"
632 FOR I=1 TO 2
633 GOSUB _assert:ARGS "S$(%%)=STRING$(80)" % (I)
634 NEXT
636 FOR I=3 TO 25
637 GOSUB _assert:ARGS "S$(%%)=STRING$(80,%%)" % (I,I+29)
638 NEXT
