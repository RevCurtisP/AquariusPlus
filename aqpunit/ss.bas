...
220 GOSUB _assert_err:ARGS "S$[0]",5
221 FOR I=1 TO 4
...
230 FOR F=0 TO 5:FOR T=0 TO 5
232 IF F=0 OR T=0 OR T<F THEN GOSUB _assert_err:ARGS "S$[%% TO %%]" % (F,T),5:GOTO 236
233 M$=MID$(S$,F,T-F+1)
...
320 FOR F=0 TO B:FOR T=0 TO B:FOR L=1 TO B
322 L$=STRING$(L,"*")
