...
110 GOSUB _init
123 SET FNKEY 3 TO \"RUN ss.baq\r"
124 SET FNKEY 4 TO \"RUN sx.baq\r"
130 SCREEN 2,,,,1:RESET PALETTE 0:CLS:SCREEN 3

180 PRINT:PRINT $"07"+"WARNING: FLASHING SCREENS"
182 PRINT:PRINT "Press Q to quit, any other key to continue"
184 K=GETKEY:IF K='Q' or K='q' THEN END
186 PRINT:IF QU=0 THEN QL=QL+5
...
246 COPY $3000,1024 TO @33,0:V=IN($E0)
...
268 COPY $3000,2048 TO @33,0:P$=GETPALETTE$(0):V=IN($E0)
...
335 Z=IN($E0):OUT $E0,Z OR $80:COPY $3000,2048 TO @33,2048:OUT $E0,Z
...
346 COPY $3000,2048 TO @33,0:V=IN($E0)
...
355 COPY $3000,2048 TO @33,0
356 GOSUB _getkey:SWAP SCREEN:GOSUB _output:ARGS LIST$(NEXT):SWAP SCREEN
357 Z=IN($E0):OUT $E0,Z OR $80:COPY $3000,2048 TO @33,2048:OUT $E0,Z
...
367 COPY $3000,2048 TO @33,0:P$=GETPALETTE$(0):V=IN($E0)
368 SWAP SCREEN:GOSUB _output:ARGS LIST$(NEXT):SWAP SCREEN
369 Z=IN($E0):OUT $E0,Z OR $80:COPY $3000,2048 TO @33,2048:OUT $E0,Z
