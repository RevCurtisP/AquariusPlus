...
324 COPY @32,0,256 TO @50,0
326 GOSUB _assert:ARGS "COMPARE(@32,0,@50,0,256)"
...
354 COPY @32,7,256 TO @50,5
356 GOSUB _assert:ARGS "COMPARE(@32,7,@50,5,256)"
...
384 COPY @32,$3F80,256 TO @50,$3F00
386 GOSUB _assert:ARGS "COMPARE(@32,$3F80,@50,$3F00,256)"
