...
502 DEF TILELIST T$=501,502,503
504 GOSUB _output:ARGS LIST$(NEXT)
506 APPEND TILELIST T$=504,505
508 GOSUB _assert:ARGS "T$=$`F501F601F701F801F901`"

510 GOSUB _output:ARGS LIST$(NEXT)
512 DEF ATTRLIST R$ = 2,4
514 GOSUB _output:ARGS LIST$(NEXT)
516 APPEND ATTRLIST R$ = 6,8,64
518 GOSUB _assert:ARGS "R$=$`0204060840`"

520 GOSUB _output:ARGS LIST$(NEXT)
522 DEF PALETTELIST P$ = 0
524 GOSUB _output:ARGS LIST$(NEXT)
526 APPEND PALETTELIST P$ = 1,0,2,3 
528 GOSUB _assert:ARGS "P$=$`0001000203`"
