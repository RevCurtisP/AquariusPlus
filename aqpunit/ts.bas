...
210 GOSUB _output:ARGS LIST$(211)
...
212 GOSUB _output:ARGS LIST$(213)
213 SET PALETTE 0 TO R$
216 GOSUB _assert:ARGS "GETPALETTE$(0)=R$"
...
240 GOSUB _output:ARGS LIST$(241)
...
253 GOSUB _output:ARGS LIST$(254)
254 POKE @20,$1000,$FF
...
260 GOSUB _output:ARGS LIST$(261)
