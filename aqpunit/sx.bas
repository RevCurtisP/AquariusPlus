...
303 FILL BYTES @20,0,16384,$5A:FILL BYTES @32,0,32768,0:SET PALETTE 1 TO STRING$(32,0)
...
646 GOSUB _assert:ARGS "F=288"
647 GOSUB _assert:ARGS "COMPARE(@20,9248,@32,0,3936)"
648 GOSUB _assert:ARGS "PEEK(@20,9215)=$5A"
649 GOSUB _assert:ARGS "PEEK(@20,13184)=$5A"
...
702 FILL BYTES @20,0,16384,$5A:FILL BYTES @32,0,16384,$5A
...
761 FILL BYTES @20,0,16384,$5A:FILL BYTES @32,0,16384,$5A
