...
881 _passed: GOSUB _output:ARGS "Passed:"+STR$(QR(1))
882 _failed: GOSUB _output:ARGS "Failed:"+STR$(QR(0))
883 _errors: GOSUB _output:ARGS "Errors:"+STR$(QR(2))
884 GOSUB _outnewline
...
958 _outquoted:GOSUB _quotes:ARGS QA$ RETURN QU$:GOTO _output:ARGS QU$
