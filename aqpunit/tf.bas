...
110 GOSUB _init
123 SET FNKEY 3 TO \"RUN tf.baq\r"
124 SET FNKEY 4 TO \"RUN tr.baq\r"
...
251 GOSUB _output:ARGS LIST$(NEXT):IF QU THEN PRINT "."; 
252 FILL WORD @40,0,$1000,501+(P+A)*256
...
259 NEXT:GOSUB _pause:NEXT:NEXT:IF QU THEN PRINT:QL=QL+1
