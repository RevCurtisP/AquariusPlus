...
;
; Key: F1  F2  F3  F4  F5  F6  F7  F8  F9  F10 F11 F12 F13 F14 F15 F16
; Hex: $80 $81 $82 $83 $84 $85 $86 $87 $90 $91 $92 $93 $94 $95 $96 $97
; Dec: 128 129 130 131 132 133 134 135 144 145 146 147 148 149 150 159
;-----------------------------------------------------------------------------
...
; Shifted Keys
    ...
    byte    '_','^','?','P','L','<',$8A,$9A ; PgUp, End
    byte    ')','O','K','M','N','J',$9B,$8B ; Home, PgDn
