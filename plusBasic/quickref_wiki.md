...
## Statements and Functions
 ...
 - **[INPUT {_stringliteral_;}_var_{,...}](BASIC-INPUT-Statement#input)** - Prompt for keyboard input and assigns entries to variables.
 - **[INPUT (_col_,_row_),_minlen_,_maxlen_,{INT|STR} _var_](BASIC-INPUT-Statement#input)** - Enhanced keyboard input routine.
 ...
 - **[RECT (_x_,y_)-(_x_,_y_){,{_drawchars_}{,«_fgcolor_,_bgcolor_»|«_drawcolors_»}}](BASIC-Screen-Draw-Statements-and-Functions#rect)** - Draw rectangle on text screen.
 ...
 - **[RESET PALETTE _palette_|\*](BASIC-Palette-Statements-and-Functions#reset-palette)** - Reset single palette or all palettes to default RGB values.
