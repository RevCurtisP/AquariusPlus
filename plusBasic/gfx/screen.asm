...
screen_write_string:
    ...
    pop     hl                    ; HL = AdrOfs; Stack = RtnAdr
    push    de                    ; Stack = StrAdr, RtnAdr
    push    hl                    ; Stack = AdrOfs, StrAdr, RtnAdr
...
color_write_byte:
    ...
    ret     c
    ex      af,af'
    jr      nz,.write80           ; If 40 columns
    ld      de,$3400              ;   Convert AdrOfs to Color address
    jr      _write_b_to_hl        ;   and write byte   
.write80    
    ld      de,$3000              ; Else
