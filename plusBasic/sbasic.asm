; Aquarius+ Microsoft 8K BASIC ROM 
; Modded 2023-2025 - Curtis F Kaylor 
; 
;BASIC Constants
...
;;; Execute Aquarius+ Extended BASIC Cold Start
...
INITFF: ld      a,r               ;;Read random number from Refresh Register
        ...
        xor     a                 ;; | No scrambling                          0153  add     a,c
...
CHEAD:  ld      h,d               ;[H,L]=[D,E]
        ...
        or      (hl)              ;[M80] 2ND BYTE
;;; + Make CHEAD return
        jp      z,CRCONT          ; + RET                                     048E  jp      z,MAIN
...
;; + Add 512 byte of buffer space between top of stack and bottom of string space
...
CLEARS: ld      a,l               ;[M80] SUBTRACT [H,L]-[D,E] INTO [D,E]
        ...
        ld      bc,512+40         ;; + Include buffer space                   0CF8  ld      bc,40
...
STRADI: push    hl                ;[M80] SAVE DESC. POINTER
...
INCHRI: jp      INCHRA            ;; +                                        1E81  ld      hl,(RESPTR)
        ...
        ld      (RESPTR),hl
        or      a
        jp      nz,KEYRET         ;; + Stop auto-styping                      1E9B  jp      p,KEYRET
                                  ;; + when ASCII null is encountered         1E9C
                                  ;; +                                        1E9D
        xor     a                                                             
        ld      (RESPTR+1),a                                                  
;;Scan Keyboard
...
KEYLUP: add     ix,de             ;;Get pointer into table
        ...
        or      a                 ;;Reserved Word? 
        jp      KEYRET            ;; + Don't expand Ctrl-Keys                 1F1F  jp      p,KEYRET
                                  ;; +                                        1F20
                                  ;; +                                        1F21
