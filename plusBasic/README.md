...
## Statements and Functions
 ...
 - [ ] **DEF RECTLIST _strvar_ = _x1_,_y1_,_x2_,_y2_{;...}** - Create string list of rectangle coordinates<!--defstrlist-->
 ...
 - [ ] **RESET PALETTE _palette_|\*** - Reset single palette or all palettes to default RGB values.<!--palette-->
 ...
 - [ ] **SAVE SCREEN _filespec_,ASC** - Save text screen to text file.<!--screenio-->
